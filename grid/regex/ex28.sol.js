...
/**
 * Сложность: 10 — максимальная сложность: 4 lookahead-а сразу (AND по 4 условиям), ОДИН из
 *             них ещё и с вложенной группой-квантификатором внутри
 *             (?:\S*[0-9]\S*){3,}, плюс юникод-классы \p{S}\p{P} и жёсткая
 *             граница длины {24,256} — несколько тяжёлых техник одновременно
 */
module.exports = f;
